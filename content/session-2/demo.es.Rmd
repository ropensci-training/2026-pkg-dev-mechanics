...
- `devtools::test()` o [Ctrl + Shift + T](https://positron.posit.co/guide-r.html#keyboard-shortcuts).

- `devtools::check()` o [Ctrl + Shift + E](https://positron.posit.co/guide-r.html#keyboard-shortcuts).
