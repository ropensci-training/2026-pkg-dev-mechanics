...
* `devtools::check()` (o Ctrl + Shift + E), `usethis::use_mit_license`. Si uso `devtools::check()` todo permanece en la consola de R. Si uso la comanda de Positron, asi es:
...
- `devtools::document()` (o Ctrl + Shift + E), `?what_time`, muestra el archivo Rd.
